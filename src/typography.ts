  ...
  printChar(x: number, y: number, char: string) {
    switch (char) {
      ...
      case "l":
        ...
        return;
      case "i":
        this.ctx.fillRect(x + 2 * BLOCK_SIZE, y, BLOCK_SIZE, TEXT_SIZE);
        return;
      case "a":
        this.ctx.fillRect(x, y, BLOCK_SIZE, TEXT_SIZE);
        this.ctx.fillRect(x + TEXT_SIZE - BLOCK_SIZE, y, BLOCK_SIZE, TEXT_SIZE);
        this.ctx.fillRect(x, y, TEXT_SIZE, BLOCK_SIZE);
        this.ctx.fillRect(x, y + 2 * BLOCK_SIZE, TEXT_SIZE, BLOCK_SIZE);
        return;
      case "h":
        this.ctx.fillRect(x, y, BLOCK_SIZE, TEXT_SIZE);
        this.ctx.fillRect(x + TEXT_SIZE - BLOCK_SIZE, y, BLOCK_SIZE, TEXT_SIZE);
      ...
      case "0":
        ...
        return;
      case "v":
        this.ctx.fillRect(x, y, BLOCK_SIZE, 3 * BLOCK_SIZE);
        this.ctx.fillRect(
          x + TEXT_SIZE - BLOCK_SIZE,
          y,
          BLOCK_SIZE,
      ...
      case "r":
        ...
        return;
      case "y":
        this.ctx.fillRect(x, y, BLOCK_SIZE, 2 * BLOCK_SIZE);
        this.ctx.fillRect(
          x + TEXT_SIZE - BLOCK_SIZE,
          y,
          BLOCK_SIZE,
      ...
      case "2":
        ...
        this.ctx.fillRect(x, y + 2 * BLOCK_SIZE, BLOCK_SIZE, 2 * BLOCK_SIZE);
        this.ctx.fillRect(x, y + TEXT_SIZE - BLOCK_SIZE, TEXT_SIZE, BLOCK_SIZE);
        this.ctx.fillRect(x, y, TEXT_SIZE, BLOCK_SIZE);
        this.ctx.fillRect(x, y + 2 * BLOCK_SIZE, TEXT_SIZE, BLOCK_SIZE);
        return;
      ...
      case "4":
        this.ctx.fillRect(x, y, BLOCK_SIZE, 3 * BLOCK_SIZE);
        this.ctx.fillRect(x, y + 3 * BLOCK_SIZE, TEXT_SIZE, BLOCK_SIZE);
        this.ctx.fillRect(
          x + TEXT_SIZE - BLOCK_SIZE,
          y + TEXT_SIZE,
          BLOCK_SIZE,
